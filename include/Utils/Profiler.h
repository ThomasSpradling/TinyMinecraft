...
#define VARNAME(Var) CAT(Var, __LINE__)
  ...
  #define PROFILE_FUNCTION_Misc() Utils::Profiler VARNAME(timer) {__FUNCTION__};
  #define PROFILE_SCOPE_Misc(name) Utils::Profiler VARNAME(timer) {name};
  #define PROFILE_FUNCTION(category) Utils::Profiler VARNAME(timer) {__FUNCTION__, Utils::ProfileCategory::category};
  #define PROFILE_SCOPE(category, name) Utils::Profiler VARNAME(timer) {name, Utils::ProfileCategory::category};
#else
