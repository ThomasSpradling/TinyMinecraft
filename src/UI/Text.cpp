...
// void Text::SetProjection(const glm::mat4 &ortho) {
//   projection = ortho;
// }

// void Text::Render(Graphics::Shader &textShader, Graphics::Texture &fontMap) {
//   // Draw("TEXT RENDERING WORKS!", 0, 0, glm::vec3(1, 0, 0));
//   // Update();
